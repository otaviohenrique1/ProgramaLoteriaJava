...
public class ProgramaLoteriaJava3 extends JFrame
{
    ...
    {
        ProgramaLoteriaJava3 XX = new ProgramaLoteriaJava3();
    }
    public ProgramaLoteriaJava3()
    {
                            ...
                            if(y3 == x1 || y3 == x2 || y3 == x3 || y3 == x4 || y3 == x5 || y3 == x6)
                            {
                                if(y4 == x1 || y4 == x2 || y4 == x3 || y4 == x4 || y4 == x5 || y5 == x6)
                                {
                                    if(y5 == x1 || y5 == x2 || y5 == x3 || y5 == x4 || y5 == x5 || y5 == x6)
                                    {
                                        ...
                                        {
                                            LabelResultados[8].setText(" " + i + " ");
                                            LabelResultados[1].setText(" " + x1 + " "); LabelResultados[2].setText(" " + x2 + " "); LabelResultados[3].setText(" " + x3 + " "); 
                                            LabelResultados[4].setText(" " + x4 + " "); LabelResultados[5].setText(" " + x5 + " "); LabelResultados[6].setText(" " + x6 + " ");
                                        }
                                    }
                                }
                            }
